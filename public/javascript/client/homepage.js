    ...
    document.getElementById('startGame').onclick = function (e) {
        ...
        var z = setInterval(function () {
            if (document.getElementById('time').innerHTML > 0) {
                ...
                gameOver = true;
                document.getElementById('pointResult').innerHTML = document.getElementById('point').innerHTML;
                document.getElementById('percent').innerHTML = document.getElementById('point').innerHTML;
