...
@section('content')
    <div class="container">
        <div class="sidebar">
            <li>
                <h3>My Account</h3>
                <ul><a href="http://127.0.0.1:8000/client/login">Sign in/sign up</a></ul>
                <ul><a href="">My Wish List</a></ul>
                <ul><a href="">My Cart</a></ul>
            </li>
            <li>
                <h3>Service</h3>
                <ul><a href="">Store Location</a></ul>
                <ul><a href="" id="returnPolicy">Return Policy</a></ul>
                <ul><a href="" id="warranty">Item Care & Warranty</a></ul>
                <ul><a href="" id="payment">Payment Options</a></ul>
            </li>
            <li>
                <h3>About Us</h3>
                <ul><a href="">Who We Are</a></ul>
                <ul><a href="" id="contact">Contact Us</a></ul>
            </li>
        </div>
            ...
            <div class="mainContent_service">
                ...
                <div class="mainContent_service-storeLocation">
                    ...
                    <div class="mainContent_service-storeLocation-location">
                        <p>285 - Doi Can Street - Ba Dinh - Ha Noi</p>
                        <p>Opening Hour: 8.00 Am - 10.00 Pm</p>
                    </div>
                </div>
                <h2>Return Policy</h2>
                <div class="mainContent-return">
                    <p>Obviously, we want you to be completely satisfied with your purchase and will gladly accept returns
                        or exchanges of unworn or defective merchandise with original packaging and tags attached up to 14
                        days from date shipment was received.</p>
                    <p style="color: red">Merchandise eligible for return must be unused, unworn, and in good condition with
                        original hangtags
                        and packaging attached.</p>
                    <h4>How to return your item?</h4>
                    <p>1. Log into the Policy Return Portal using the email address associated with the order and your order
                        number (you can find your order number in your order confirmation email or receipt with purchase)
                        **check your spam folder if you did not receive an order confirmation</p>
                    <p>2. In the Returns Portal, select the item(s) you wish to return, select a reason for your return, and
                        click COMPLETE RETURN.</p>
                    <p>3. Confirm your refund. This will include taxes and any discounts applied, but exclude shipping
                        costs.</p>
                    <p>4. Print your prepaid return label and return packing slip. Put the return packing slip in the box
                        with your item(s) and place the return label on the box. Drop the box at your nearest PostOffice or
                        shipping center.</p>
                ...
                <div class="mainContent-itemCareWarranty">
                    ...
                    <div class="mainContent-warranty">
                        ...
                        <p style="color: red">3: A copy of the proof of purchase (original receipt, pack slip, or credit card statement)</p>
                    </div>
                </div>
                ...
                <div class="mainContent-payment">
                    ...
                    <p>You can use paypal to pay for your order on Pursellet.com. Paypal enables you to securely send
                        ...
                        credit card and bank numbers are never seen by us, plus you're 100% protected against unauthorized
                        payments sent from your account. Paypal customer service representatives are available to assist you
                        at 0396437884</p>
                    <h4>BILLING INFORMATION:</h4>
                    <p>For your security, your billing name, address, and phone number must match that of the credit card
                        used for payment. We reserve the right to cancel any order that does not match these criteria.</p>
                </div>
                <h2>About Us</h2>
                <div class="mainContent-aboutus">
                    ...
                    <p>since our launch in 2022, we’ve always stood for optimistic femininity.
                        ...
                        it’s these founding principles that define our unique style. we like that our style is synonymous
                        with joy.
